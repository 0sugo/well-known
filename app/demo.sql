...
CREATE TABLE `property_details` (
  ...
  `county_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sub_county_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `plot_number` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
