                                                        ...
                                                        <div class="tenants-inner-box-block">
                                                            ...
                                                            <div class="row location" id="previous">
                                                                <div class="col-md-4 mb-25">
                                                                    <label
                                                                        class="label-text-title color-heading font-medium mb-2">{{ __('County') }}</label>
                                                                ...
                                                                <div class="col-md-4 mb-25">
                                                                    <label
                                                                        class="label-text-title color-heading font-medium mb-2">{{ __('Sub-county') }}</label>
                                                                    <input type="text" name="previous_state_id"
                                                                        class="form-control"
                                                                        placeholder="{{ __('Sub-county') }}">
                                                                </div>
                                                                <div class="col-md-4 mb-25">
                                                                    <label
                                                                        class="label-text-title color-heading font-medium mb-2">{{ __('Location') }}</label>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="tenants-inner-box-block">
                                                            ...
                                                            <div class="row location" id="permanent">
                                                                <div class="col-md-4 mb-25">
                                                                    <label
                                                                        class="label-text-title color-heading font-medium mb-2">{{ __('County') }}
                                                                        <span class="text-danger">*</span></label>
                                                                ...
                                                                <div class="col-md-4 mb-25">
                                                                    <label
                                                                        class="label-text-title color-heading font-medium mb-2">{{ __('Sub-county') }}
                                                                        <span class="text-danger">*</span></label>
                                                                ...
                                                                <div class="col-md-4 mb-25">
                                                                    <label
                                                                        class="label-text-title color-heading font-medium mb-2">{{ __('LOcation') }}
                                                                        <span class="text-danger">*</span></label>
